...
//		System.out.println(obj.doubleValue());
	...
	/**
	 * DML的测试，就是测试INSERT、UPDATE、DELETE操作
	 */
...
//		new MySqlQuery().update(e,new String[]{"empname"});
//		new MySqlQuery().update(e,new String[]{"empname","age","salary"});
		List<Emp>emp=new MySqlQuery().queryRows("select * from sorm.emp where salary>? and age>?",e.getClass(),new String[] {"10000","30"});
		for(Emp ep:emp) {
			//System.out.println(ep.getId()+" "+ep.getEmpname()+" "+ep.getBirthday());
